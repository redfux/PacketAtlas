...
6. **Details ansehen:** Beim Überfahren einer Matrixzelle, einer Kante/eines Knotens im Graphen, eines Pfeils in der Verbindungen-Ansicht bzw. eines Balkens in der Zeitleiste erscheint ein Tooltip mit Source IP → Destination IP (ein einzelner Pfeil zeigt immer, wer die Kommunikation initiiert hat), Protokoll, Source Port/Destination Port, Paket-/Bytezahl und Zeitraum der Kommunikation.
