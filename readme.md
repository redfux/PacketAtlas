...
6. **Details ansehen:** Beim Überfahren einer Matrixzelle, einer Kante/eines Knotens im Graphen, eines Pfeils in der Verbindungen-Ansicht bzw. eines Balkens in der Zeitleiste erscheint ein Tooltip mit Protokoll, Ports (eindeutig „Ports bei ⟨Gerät⟩" bzw. „Quell-Port"/„Ziel-Port" zugeordnet, nicht mehr nur als vermischte Liste), Paket-/Bytezahl und Zeitraum der Kommunikation.
